...
namespace RefactorThis.Domain.Tests
{
    ...
    public class InvoicePaymentProcessorTests
    {
        ...
        [Test]
        public void ProcessPayment_ShouldReturnNoPayment_When_Invoice0AndPaymentsMade()
        {
            var repo = new InvoiceRepository();

            repo.Add(new Invoice(repo)
            {
                Amount = 0,
                AmountPaid = 10,
                Payments = new List<Payment>()
        ...
        [Test]
        public void ProcessPayment_ShouldThrowException_When_Amount0AndPaymentsPresent()
        {
            var repo = new InvoiceRepository();
